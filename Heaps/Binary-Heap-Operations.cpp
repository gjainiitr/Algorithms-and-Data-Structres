/*
	Problem URL :- https://practice.geeksforgeeks.org/problems/operations-on-binary-min-heap/1
*/
...
void MinHeap ::insertKey(int k)
{
   ...
   while(curr!=0 && harr[parent(curr)]>harr[curr]) {
       swap(harr[parent(curr)], harr[curr]);
       curr = parent(curr);
   }
}
